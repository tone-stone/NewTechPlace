        ...
        <div class="topbar">
            ...
            <div class="topbar-right">
                <div class="user-profile">
                    <div class="user-avatar"><?php echo htmlspecialchars($usuario_actual['inicial'], ENT_QUOTES, 'UTF-8'); ?></div>
                    <span><?php echo htmlspecialchars($usuario_actual['nombre'], ENT_QUOTES, 'UTF-8'); ?></span>
                </div>
